...
make release-show RELEASE_VERSION=0.1.0-rc.2
make release-verify-assets RELEASE_VERSION=0.1.0-rc.2
make release-promote-check RELEASE_VERSION=0.1.0-rc.2
make release-watch
